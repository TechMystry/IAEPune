...
export default function AboutSection() {
  return (
    <section
      id="about-us"
      className="h-screen px-6 bg-gray-50 font-sans scroll-mt-20 flex items-center" // ⬅️ full screen height + center content vertically
    >
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-10 items-start justify-center">
        ...
        <div className="flex-1 min-w-[300px] bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-8 shadow-md">
